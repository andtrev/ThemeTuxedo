...
class Tux_AdminPage_Setting {
	...
	/**
	 * The id of the section for the setting.
	 *
	 * @since 1.0.0
	 *
	 * @access public
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( $this->sanitize_callback )
			add_filter( "tux_ap_sanitize_{$this->id}", $this->sanitize_callback, 10, 2 );
	...
	public function set_value( $value ) {
		 ...
		 */
		$this->_value = apply_filters( "tux_ap_sanitize_{$this->id}", $value, $this );
